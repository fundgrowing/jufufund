...
const BLOG = {
  AUTHOR: 'funder', // 作者
  BIO: '一个普通的小财迷💰', // 作者简介
  LINK: 'https://hugefund.eu.org', // 网站地址
  KEYWORDS: '经济,理财,基金,干货,定投', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '2ff1190bf1de42d48cea3a89333e3e26', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '20258832-3ef8-4093-a7cc-59e1f1edf230', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
